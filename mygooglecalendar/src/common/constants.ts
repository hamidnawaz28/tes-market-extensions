const APP_URL = 'https://mygooglecalendar.com/'
const APP_URL_ONLOAD = 'https://search.mygooglecalendar.com/'
const APP_NAME = 'My Google Calendar'
const STORE_NAME = 'mygooglecalendar'
